...
def genetic_algorithm(midpoint_method, test_function, population_lower_limit, population_upper_limit, dimensions=2, population_size=100, crossover_rate=0.7, mutation_rate=0.01, variance=0.04, epsilon=1e-10, max_generations=10000):
